                ...
                <div class="col-lg-8">
                    ...
                    <div class="pb-3">
                        ...
                        <div class="bg-white mb-3" style="padding: 30px;">
                            ...
                            <h2 class="mb-3">{{$post->translate()->title}}</h2>
   ...
   <br>
    ...
    <!-- like form end -->
       ...
       <div class="">
        ...
        <div id="social-links">
            <ul>
                <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://127.0.0.1:8000/posts/{{$post->slug}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-facebook-square"></span></a></li>
                <li><a href="https://twitter.com/intent/tweet?text={{$post->translate()->title}}&amp;url=http://127.0.0.1:8000/posts/{{$post->slug}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-twitter"></span></a></li>
                <li><a target="_blank"
                        href="https://telegram.me/share/url?url=http://127.0.0.1:8000/posts/{{$post->slug}}&amp;text={{$post->translate()->title}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-telegram"></span></a></li>
                <li><a target="_blank" href="https://wa.me/?text=http://127.0.0.1:8000/posts/{{$post->slug}}"
                        class="social-button " id="" title="" rel=""><span
    ...
    <!-- share end -->
                    ...
                    <div class="bg-white mb-3" style="padding: 30px;">
                        ...
                        <form method="POST" action="/postcomments/{{$post->id}}">
                            @csrf
