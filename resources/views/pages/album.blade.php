...
<div class="container-fluid py-5">
                        ...
                        <div class="col-md-4 mb-4 pb-2">
                            <div class="blog-item">
                                <div class="position-relative">
                                    <a href="{{$photo->path}}"><img class="img-fluid w-100" style="height: 300px; object-fit: fill;" src="{{$photo->path}}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    @if(Auth::check())
                 ...
                 <div class="like-dislike-container">
                    ...
                    <div class="icons-box">
                        <div class="icons">
                            <form action="/likealbum/{{$album->id}}" method="post">
                                @csrf
                        ...
                        <div class="icons">
                            <form action="/dislikealbum/{{$album->id}}" method="post">
                                @csrf
       ...
       <div class="">
        ...
        {{-- <div id="social-links">
            <ul>
                <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://127.0.0.1:8000/album/{{$album->name}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-facebook-square"></span></a></li>
                <li><a href="https://twitter.com/intent/tweet?text={{$album->name}}&amp;url=http://127.0.0.1:8000/album/{{$album->name}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-twitter"></span></a></li>
                <li><a target="_blank"
                        href="https://telegram.me/share/url?url=http://127.0.0.1:8000/album/{{$album->name}}&amp;text={{$album->name}}"
                        class="social-button " id="" title="" rel=""><span
                            class="fab fa-telegram"></span></a></li>
                <li><a target="_blank" href="https://wa.me/?text=http://127.0.0.1:8000/album/{{$album->name}}"
                        class="social-button " id="" title="" rel=""><span
    ...
    <!-- share end -->
                                ...
                                {{-- <div class="bg-white mb-3" style="padding: 30px;">
                                    ...
                                    <form method="POST" action="/albumcomments/{{$album->id}}">
                                        @csrf
                                ...
                                {{-- <div class="bg-white" style="padding: 30px; margin-bottom: 30px;">
                                    ...
                                    <div class="media mb-4">
                                        <div class="media-body">
                                            <h6><a>{{$comment->users->name}}</a> <small><i>{{$comment->created_at->format('d/M/Y')}}</i></small></h6>
                                            <p>{{$comment->body}}</p>
                                        </div>
                                    </div>
                                    <hr>
...
<div class="container pt-5 pb-3">
    <div class="text-center mb-3 pb-3">
        <h6 class="text-primary text-uppercase" style="">{{$album->name}}</h6>
        <h3>{{$album->desc}}</h3>
    </div>
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="package-item bg-white mb-2">
                <a href="{{$photo->path}}"><img class="img-fluid" style="width: 370px;height:350px;object-fit: cover;" src="{{$photo->path}}" alt=""></a>
            </div>
        </div>
        @endforeach
    </div>
