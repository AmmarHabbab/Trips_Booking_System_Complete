        ...
        <div class="col-lg-5">
            <div class="card border-0">
                ...
                <div class="card-body rounded-bottom bg-white p-5">
                    <form method="POST" action="/book/payment/syriatelcash/{{$payment->id}}" >
                        @csrf
                        @if ($errors->any())
                            <div class="mb-4">
                        ...
                        <label for=""><b>{{__('messages.Send')}}{{$payment->amount}}{{__('messages.using syriatel cash To this number : ')}}0934558864 {{__('messages.Then Enter the phone number you used to send the money')}}</b></label><br>
                        <label class="" for="image"><b>{{__('messages.Phone number')}}</b></label>
                        <div class="form-group">
                            <input type="number" class="form-control p-4" placeholder="{{__('messages.Enter your number')}}" name="syrnumb">
                        </div>
                        <div class="form-group">
                            <div>
